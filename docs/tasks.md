...
- [ ] Add edit/delete actions for project endpoints in the Web UI.
- [ ] Add edit/delete actions for project components in the Web UI.
- [ ] Add edit/delete actions for project dependencies in the Web UI.
